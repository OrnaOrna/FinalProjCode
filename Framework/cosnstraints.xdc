...
set_property SLEW SLOW [get_ports gpio_startn]
...
set_property SLEW SLOW [get_ports gpio_endn]
set_property SLEW SLOW [get_ports gpio_exec]
...
set_property SLEW SLOW [get_ports osc_en_b]
...
create_clock -period 41.666 -name clkin_grp -waveform {0.000 20.833} [get_ports *lbus_clkn*]
